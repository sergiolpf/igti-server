...
// Client lists the step service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the step service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// List returns an endpoint that makes HTTP requests to the step service list
// server.
...
// Add returns an endpoint that makes HTTP requests to the step service add
// server.
