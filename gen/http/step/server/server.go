...
// New instantiates HTTP handlers for all the step service endpoints using the
...
func (s *Server) Service() string { return "step" }
...
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/steps/{id}", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "step" service "list" endpoint.
func NewListHandler(
...
// MountAddHandler configures the mux to serve the "step" service "add"
// endpoint.
...
// MountUpdateHandler configures the mux to serve the "step" service "update"
// endpoint.
