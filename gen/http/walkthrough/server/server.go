...
// MountRenameHandler configures the mux to serve the "walkthrough" service
// "rename" endpoint.
func MountRenameHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/walkthrough/rename", f)
}

// NewRenameHandler creates a HTTP handler which loads the HTTP request and
// calls the "walkthrough" service "rename" endpoint.
