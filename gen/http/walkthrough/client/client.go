...
//
// walkthrough client HTTP transport
//
// Command:
...
// Client lists the walkthrough service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the walkthrough service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// List returns an endpoint that makes HTTP requests to the walkthrough service
// list server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("walkthrough", "list", err)
		}
		return decodeResponse(resp)
	}
}

// Show returns an endpoint that makes HTTP requests to the walkthrough service
// show server.
func (c *Client) Show() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("walkthrough", "show", err)
		}
		return decodeResponse(resp)
	}
}

// Add returns an endpoint that makes HTTP requests to the walkthrough service
// add server.
func (c *Client) Add() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("walkthrough", "add", err)
		}
		return decodeResponse(resp)
	}
}

// Remove returns an endpoint that makes HTTP requests to the walkthrough
...
func (c *Client) Remove() goa.Endpoint {
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("walkthrough", "remove", err)
		}
		return decodeResponse(resp)
	}
}

// Update returns an endpoint that makes HTTP requests to the walkthrough
